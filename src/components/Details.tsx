        ...
        <div className='grid grid-cols-2 p-4'>
            ...
            <div className='p-5'>
                ...
                <div className='flex items-center mt-4'>
                    <h1 className='text-2xl font-bold'>Rs. {location.state.data.price*10}</h1>
                    <h1 className='text-xl text-gray-500 ml-2'>MRP</h1>
                    <h1 className='line-through text-xl text-gray-500 ml-1'>{location.state.data.price*10 + 500}</h1>
                    <h1 className='text-orange-500 ml-2 font-bold text-lg'>(Rs. 500 OFF)</h1>
                </div>
                <h1 className='text-green-600 font-semibold mt-3'>inclusive of all taxes</h1>
